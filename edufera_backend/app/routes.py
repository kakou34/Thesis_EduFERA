...
from edufera_backend.app.sample_data_generator import generate_data
...
def attendances():
    ...
    return make_response(f'Meeting: {meeting_id} does not exist!')


@app.route('/generate_data', methods=['GET'])
def generate():
    generate_data('C:/Users/99926527616etu/PycharmProjects/Thesis_EduFERA/edufera_backend/app/dummy_data.csv')
